...
| `.claude/rules/publish.md` | `src/core/publish/**`, `src/cli/publish.ts` | Evaluated draft immutability during site-pr/site-update, platform image reference modes, deterministic config-derived image generation |
...
| Publish rules | `.claude/rules/publish.md` | Site PR/update draft immutability, platform image reference handling |
