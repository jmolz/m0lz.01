...
# Evidence/proof notes may also live in plans directories and must not mask the feature plan.
...
- `src/core/publish/distribution-kit.ts` — durable social/distribution-kit generation, manifest validation, upload checklists, table/image hash verification
- `src/core/publish/site-artifacts.ts` — direct distribution-kit site persistence, owned artifact cleanup, strict staged/ahead guards
