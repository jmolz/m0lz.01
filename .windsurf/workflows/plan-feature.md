---
description: Research and create a comprehensive implementation plan for a feature. Usage - provide feature description as argument
---
...
Use the template at `.claude/templates/plan-template.md` if it exists — fill in every section with real data from the research.
