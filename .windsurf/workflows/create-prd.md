---
description: Generate a Product Requirements Document from the current conversation. Usage - provide output path as argument (default .claude/PRD.md)
---
...
Write to the path specified by the user (default: `.claude/PRD.md`)
...
Read and follow the template at `.claude/templates/PRD-template.md` if it exists.
