---
description: Grade implementation against a plan's contract using an isolated adversarial evaluator. Usage - provide path to plan file as argument
---
...
Run the following via Bash in the background (so Claude evaluation can proceed in parallel):
